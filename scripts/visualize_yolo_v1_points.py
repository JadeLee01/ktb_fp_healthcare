...
def visualize_yolo_dataset(dataset_path, output_path, fps=30):
    ...
    if not output_path.endswith('.mp4'):
        ...
        output_video_path = os.path.join(output_path, "v1_basic_points.mp4")
    else:
    ...
    # 4. Process
    for img_path in tqdm(image_files, desc="Visualizing (V1: Points)"):
            ...
            for line in lines:
                ...
                for i in range(num_kpts):
                    ...
                    if kv > 0 and (kx != 0 or ky != 0):
                        ...
                        # V1: Simple Red Points for everything
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualize YOLO Dataset V1 (Basic Points)")
    parser.add_argument("dataset_path", help="Path to dataset root")
    parser.add_argument("--output", "-o", help="Output video path", default="v1_output.mp4")
